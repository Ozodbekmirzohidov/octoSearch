...
const cards = [
  ...
  {
    label: "Followers",
    value: mockUser.followers,
    sub: `Following ${mockUser.following}`,
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
...
export default function UserProfileCards() {
  return (
    <div>
      <h2 className="text-head font-medium text-base mb-3">User profile</h2>
        ...
        {cards.map((card) => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-green text-sm">{card.value}</p>
            </div>
